...
<div class="container">
    ...
    <?php endif; ?>
        ...
        <div id="imageFields" style="display:none;">
            ...
            <input type="number" id="imageWidth" name="imageWidth" value="150"><br>

            <label for="imageHeight">Alto de la imagen (px):</label>
            <input type="number" id="imageHeight" name="imageHeight" value="150"><br>
        </div>
        ...
        <input type="number" id="intervalo" name="intervalo" min="1" required><br>
